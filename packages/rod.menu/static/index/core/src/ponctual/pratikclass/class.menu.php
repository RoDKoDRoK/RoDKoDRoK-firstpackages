...
{	
	...
	function menu_loader($menuname,$menutpl="")
	{
		...
		$builtmenu=$tpl->get_template($this->arkitect->get("pratiklib.menu")."/menu.tpl");
	...
	function getCssMenu($nommenutpl="")
	{
		...
		if(file_exists($this->arkitect->get("pratiklib.menu").$this->arkitect->get("ext.pratikmenu.css")."/menu.".$nommenutpl.".css"))
			$css.="<link rel=\"stylesheet\" href=\"".$this->arkitect->get("pratiklib.menu").$this->arkitect->get("ext.pratikmenu.css")."/menu.".$nommenutpl.".css\" type=\"text/css\" />\n";
	...
	function getJsMenu($nommenutpl="")
	{
		...
		if(file_exists($this->arkitect->get("pratiklib.menu").$this->arkitect->get("ext.pratikmenu.js")."/menu.".$nommenutpl.".js"))
			$js.="<script src=\"".$this->arkitect->get("pratiklib.menu").$this->arkitect->get("ext.pratikmenu.js")."/menu.".$nommenutpl.".js\"></script>\n";
