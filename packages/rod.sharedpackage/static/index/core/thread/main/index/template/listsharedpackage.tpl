...
{$content}
<a href="?page=formsharedpackage&typeform=insert">Add sharedpackage</a>

{section name=cpt loop=$data}
<div class="linelist">
	
{if isset($droit.edit) && $droit.edit==true}
	<a href="?page=formdeletesharedpackage&id={$data[cpt].idsharedpackage}">Delete sharedpackage</a>
	<a href="?page=formsharedpackage&id={$data[cpt].idsharedpackage}&typeform=update">Update sharedpackage</a>
{/if}
	<a href="?page=viewsharedpackage&id={$data[cpt].idsharedpackage}">View sharedpackage</a>
