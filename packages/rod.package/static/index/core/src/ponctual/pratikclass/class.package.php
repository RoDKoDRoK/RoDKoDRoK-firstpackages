...
class PratikPackage extends ClassIniter
{
	...
	function __construct($initer=array())
	{
		...
		$this->conflictfolder=$this->arkitect->get("packagetrace.conflictfolder");
	...
	function deploy($packagecodename="example")
	{
		...
		if(file_exists($this->folderdestpackage.$packagecodename))
		{
			...
			if(isset($this->db) && $this->db && file_exists($chemin_db_static))
			{
				...
				//filename creation
				$namefilecour=str_replace($this->folderdestpackage.$packagecodename."/static/",$this->folderdestdb.$packagecodename.".",$chemin_db_static);
			...
			if(isset($this->db) && $this->db && file_exists($chemin_db_generator_tpl))
			{
				...
				foreach($confgenerator->instance as $instance)
				{
					...
					$namefilecour=str_replace($this->folderdestpackage.$packagecodename."/generator/",$this->folderdestdb.$packagecodename.".",$namefilecour);
