...
class PratikDownloader extends ClassIniter
{
	...
	var $defaultsrclinkfolder="core/src/libinternal/pratiklib/downloader/srclinks/"; //set in arkitect
	...
	function __construct($initer=array())
	{
		...
		$this->defaultsrclinkfolder=$this->arkitect->get("pratiklib.downloader.srclinkfolder");
