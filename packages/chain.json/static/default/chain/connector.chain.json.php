...
$tabconnector[count($tabconnector)-1]['outputaction']="toprint-content:1-subtpl:threadwsjson";
$tabconnector[count($tabconnector)-1]['name']="pagewsjson";
...
$tabconnector[count($tabconnector)-1]['vartoiniter']=false;
$tabconnector[count($tabconnector)-1]['aliasiniter']="none";
$tabconnector[count($tabconnector)-1]['name']="threadwsjson";
